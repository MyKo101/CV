...
\toprule
\makecell[tp{0.7\textwidth}]{\textbf{ typos} (R Package) \\  The goal of typos is to provide a flexible warning when commonly mis-typed functions are called. Functions with typing errors will still be evaluated and a warning will be output. It also provides the user with a convenient function to define their own typos. } & \raisebox{-0.7\height}{\includegraphics[width=2cm]{ img/logos/typos-logo.png}}\\
\bottomrule
\end{tabular}
\end{table}
