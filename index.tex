...
\begin{tabular}{>{\raggedright\arraybackslash}p{0.2\textwidth}>{\raggedright\arraybackslash}p{0.8\textwidth}}

 & \\
\midrule
\includegraphics{ img/logos/typos-logo.png} & \textbf{ typos}\newline \ The goal of typos is to provide a flexible warning when commonly mis-typed functions are called. Functions with typing errors will still be evaluated and a warning will be output. It also provides the user with a convenient function to define their own typos.\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
